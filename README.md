...
2. `precipitation_accumulation_aes.py`: Plugin used for extracting precipitation accumulated over a user-defined interval (in seconds). Works for AES physics. Corresponding documentation for this plugin can be found [here](docs/precipitation_accumulation_aes.md)
